...
export default function ViewDataHeader({ document, onBack, exportData }: { document: any, onBack: () => void, exportData: ViewDataApiResponse }) {
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-6 shrink-0">
            ...
            <div>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500 font-medium">
                    <span className="flex items-center"><Calendar size={14} className="mr-1 text-gray-400" /> {document.date}</span>

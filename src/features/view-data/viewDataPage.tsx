        ...
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans h-screen overflow-hidden">
            ...
            <div className="flex flex-1 overflow-hidden">
                {error ? (
                    ...
                    <>
                        <ViewDataSideBar document={data} activeSectionIndex={activeSectionIndex} onSectionClick={toggleSectionExpansion} isLoading={isLoading} />
                        <ViewDataMain data={data} activeSectionIndex={activeSectionIndex} activeSection={activeSection} isLoading={isLoading} />
                    </>
                )}
            </div>
        </div>

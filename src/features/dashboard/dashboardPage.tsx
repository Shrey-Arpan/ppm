  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <footer className="py-8 text-center">
        ...
        <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest uppercase">
          &copy; {new Date().getFullYear()} AI PPM Analysis Platform &bull; Secure Enterprise
          Environment
        </p>
      </footer>
    </div>
